...
public class VentaResource {
     ...
     *
     * @return ResponseEntity con la lista de ventas y el código de estado 200 OK.
     */
    @GetMapping
     ...
     * @return ResponseEntity con la venta solicitada y el código de estado 200 OK.
     */
    @GetMapping("/{id}")
     ...
     * @return ResponseEntity con el ID de la venta creada y el código de estado 201 Created.
     */
    @PostMapping
     ...
     * @return ResponseEntity con el ID de la venta actualizada y el código de estado 200 OK.
     */
    @PutMapping("/{id}")
     ...
     * @param operador  (Opcional) Operador de comparación (mayor, menor, igual, like).
     * @return ResponseEntity con la lista de ventas que coinciden con la búsqueda y el código de estado 200 OK.
     */
    @GetMapping("/buscar")
     ...
     * @return ResponseEntity con las ganancias diarias y el código de estado 200 OK.
     */
     ...
     *
     * @param mes  Mes para el cual se calculan las ganancias mensuales (1 para enero, 2 para febrero, etc.).
     * @param anio Año para el cual se calculan las ganancias mensuales.
     * @return ResponseEntity con las ganancias mensuales y el código de estado 200 OK.
     */
     ...
     *
     * @param fechaInicio Fecha de inicio del rango para el cálculo de ganancias.
     * @param fechaFin    Fecha de fin del rango para el cálculo de ganancias.
     * @return ResponseEntity con las ganancias dentro del rango de fechas y el código de estado 200 OK.
     */
